...
from univi.nn.tasks import MultiLabelClassificationModel
...
class MultilabelClassificationTrainer(BaseTrainer):
    ...
    def get_validator(self):
        ...
        return yolo.multi_classify.MultiLabelClassificationValidator(self.test_loader, self.save_dir, _callbacks=self.callbacks)
